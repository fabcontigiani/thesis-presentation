...
\begin{frame}{El Bosque Atlántico}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item Originalmente: \num{1.3} millones de \unit{\km\squared} \parencite{ribeiro2009atlantic}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Mas del \textbf{\qty{50}{\percent} de la biodiversidad} de Argentina \parencite{dibitetti2003yaguarete}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item Censo 2024: $\sim$\num{84} individuos en el Corredor Verde \parencite{vidasilvestre2024censo}
...
\begin{frame}{Deforestacion}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\textbf{1990-2020:} $\sim$\qty{130000}{ha} perdidas solo en el Corredor Verde \parencite{fauba2024corredorverde}
			...
			\vspace{0.5em}
			\textbf{2025:} Reduccion del \qty{18}{\percent} respecto al promedio historico \parencite{ecologiamisiones2025deforestacion}
		\end{column}
		\begin{column}{0.5\textwidth}
...
\begin{frame}{Limitaciones de Camaras Tradicionales}
	\begin{alertblock}{Brechas criticas}
		\begin{description}
			...
			\item[Manual:] \qty{80}{\percent}+ de imagenes son vacias o irrelevantes \parencite{tabak2019machine}
...
\begin{frame}{MegaDetector \parencite{beery2019megadetector}}
	...
	\begin{itemize}
		...
		\item Adoptado por \num{60}+ organizaciones de conservacion \parencite{velez2022platforms}
