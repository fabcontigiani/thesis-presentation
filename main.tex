...
\begin{frame}{El Bosque Atlántico}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item Originalmente: 1.3 millones de km² \parencite{ribeiro2009atlantic}
				\item Brasil (92\%), Paraguay (6\%), Argentina (2\%)
				\item Hoy: solo 12-17\% de su extensión original
				\item Uno de los \textbf{hotspots de biodiversidad} más amenazados del planeta \parencite{wwf2024atlantic}
			\end{itemize}
		\end{column}
		\begin{column}{0.5\textwidth}
	...
	\note{
		...
		Originalmente cubría 1.3 millones de km², pero hoy queda menos del 17\%.
...
\begin{frame}{La Selva Misionera}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Mas del \textbf{50\% de la biodiversidad} de Argentina \parencite{dibitetti2003yaguarete}
	...
	\note{
		...
		de la biodiversidad del país en menos del 0.5\% del territorio.
	}
\end{frame}
...
\begin{frame}{El Yaguarete: Especie Bandera}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item Censo 2024: $\sim$84 individuos en el Corredor Verde \parencite{vidasilvestre2024censo}
	...
	\end{columns}
	\note{
		El yaguareté es la especie más emblemática. Con solo 84 individuos en el
...
\begin{frame}{Importancia Ecologica}
	...
	\vspace{1em}
	\textbf{Marco legal:} Ley 26.331 de Proteccion de Bosques Nativos \parencite{ley26331bosques}
	\begin{description}
...
\begin{frame}{Deforestacion}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\textbf{1990-2020:} $\sim$130,000 hectareas perdidas solo en el Corredor Verde \parencite{fauba2024corredorverde}
			...
			\vspace{0.5em}
			\textbf{2025:} Reduccion del 18\% respecto al promedio historico \parencite{ecologiamisiones2025deforestacion}
		\end{column}
		\begin{column}{0.5\textwidth}
	...
	\end{columns}
	\note{
		La deforestación ha sido significativa: 130,000 hectáreas perdidas en 30
		años. Aunque hay mejoras recientes (18\% de reducción en 2025), la presión
...
\begin{frame}{Desafios de la Vigilancia}
	...
	\fbox{\parbox{0.5\textwidth}{\centering\vspace{1.2cm}
			...
			\vspace{1.2cm}}}
	\note{
		780,000 hectáreas en más de 100 áreas protegidas. Sin cobertura celular,
...
\begin{frame}{Camaras Trampa Tradicionales \parencite{steenweg2017scaling}}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\textbf{Componentes:}
			\begin{itemize}
...
\begin{frame}{Limitaciones de Camaras Tradicionales}
	\begin{alertblock}{Brechas criticas}
		\begin{description}
			...
			\item[Manual:] 80\%+ de imagenes son vacias o irrelevantes \parencite{tabak2019machine}
	...
	\note{
		Las brechas críticas: latencia de semanas/meses, sin alertas, 80\% de
...
\begin{frame}{Soluciones Comerciales Celulares}
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\textbf{Ejemplos:} Tactacam REVEAL \parencite{tactacam2024reveal}, Spypoint Flex \parencite{spypoint2024cellular}
...
\begin{frame}{Trabajos Relacionados}
	\begin{description}
		\item[Barrero \& Schmunck (UNaM, 2023) \parencite{barrero2023microcamara}:] Microcamara de vigilancia para fauna - bases para soluciones de bajo costo

		\item[Whytock et al. (2023) \parencite{whytock2023iridium}:] Camaras trampa con IA + alertas satelitales Iridium - costos operativos muy altos

		\item[AiCatcher (Mallya, 2019) \parencite{mallya2019aicatcher}:] Raspberry Pi + LoRa + inferencia en borde - alto consumo energetico
	\end{description}
...
\begin{frame}{Oportunidad Tecnologica}
	...
	\end{block}
	\note{
		Tres tecnologías convergen: ESP32 a menos de 10 dólares con WiFi integrado,
...
\begin{frame}{Redes Mesh - ESP-MESH \parencite{espmesh2023}}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\textbf{Caracteristicas:}
			\begin{itemize}
...
\begin{frame}{Deteccion de Objetos con YOLO \parencite{redmon2016yolo}}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item YOLOv5: PyTorch, multiples variantes \parencite{jocher2020yolov5}
			\end{itemize}
		\end{column}
		\begin{column}{0.5\textwidth}
...
\begin{frame}{MegaDetector \parencite{beery2019megadetector}}
	...
	\begin{itemize}
		...
		\item Adoptado por 60+ organizaciones de conservacion \parencite{velez2022platforms}
		\item Reduce hasta 90\% el tiempo de procesamiento
	\end{itemize}
	\note{
		MegaDetector de Microsoft: detecta animales, personas y vehículos sin
		clasificar especies. Altamente robusto, usado por más de 60
		organizaciones. Reduce 90\% del tiempo de revisión.
	}
\end{frame}

\begin{frame}{SpeciesNet - Google \parencite{gadot2024crop}}
...
\begin{frame}{Flujo de Datos}
	...
	\end{enumerate}
	\note{
		Flujo paso a paso: PIR detecta, nodo captura JPEG menor a 8KB, transmite por
...
\begin{frame}{Nodo de Camara - Firmware}
	...
	\note{
		...
		transmisión Mwifi, modo power-save.
	}
\end{frame}
...
\begin{frame}{Desafios Enfrentados}
	...
	\end{alertblock}
	\note{
		Desafíos principales: 1) Límite 8KB por paquete mesh, 2) Consumo energético
...
\begin{frame}{Resultados - Captura de Imagen}
	...
	\note{
		...
		Compresión JPEG ajustada para mantener tamaño bajo 8KB y cumplir límite de
		paquete mesh.
	}
\end{frame}
...
\begin{frame}{Resultados - Red Mesh}
	...
	\note{
		...
		pérdida de paquetes menor al 5\%, tiempo de reconexión. Resultados
...
\begin{frame}{Resultados - Deteccion}
	...
	\note{
		...
		de inferencia: 1-5 segundos en CPU, 0.5-1 segundo con GPU. GPU recomendada
		para producción.
	}
\end{frame}
...
\begin{frame}{Análisis Económico}
	...
	\end{columns}
	\note{
		Backup: Análisis económico. Inversión inicial de 20,530 USD. Modelo de
		suscripción mensual. VAN positivo, TIR del 25\% supera TREMA del 15\%.
		Recupero en año 4. Proyecto económicamente viable.
	}
\end{frame}
...
\begin{frame}{Sensibilidad Económica}
	...
	\end{itemize}
	\note{
		Backup: Análisis de sensibilidad. Punto de equilibrio en 24 suscripciones
		anuales. Precio mínimo viable de 40 USD/mes antes de que el proyecto deje
		de ser rentable.
	}
\end{frame}
