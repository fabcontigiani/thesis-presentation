...
\begin{frame}{Red Malla - Selección de Root Node}
  \textbf{Selección automática del Root Node:}
  
  \vspace{1.1em}
  \begin{itemize}
    \setlength{\itemsep}{1em}
    \item Múltiples nodos candidatos evalúan su señal \textbf{RSSI} respecto al router de salida.
    \item El nodo con mejor relación de señal asume automáticamente el rol de \textbf{Root}.
    \item Los demás nodos candidatos se reconfiguran como secundarios/relays para evitar cuellos de botella y bucles.
  \end{itemize}
  
  \vspace{1.1em}
  \begin{block}{Prevención de Bucles}
    El protocolo mantiene un control interno (Loop Prevention) para evitar reenvíos infinitos durante la reestructuración de la topología.
  \end{block}
  \note{
