...
\begin{frame}{Escenario de Despliegue Objetivo}
  ...
  \begin{tikzpicture}[
    ...
    \node[root] (raiz) at (9.5, 1.5) {R};
    \node[below=0.05cm of raiz, font=\scriptsize\bfseries\color{orange!80!black}] {Nodo Raíz};
    ...
    \draw[extlink] (raiz) to[out=90, in=130] node[above, sloped, font=\scriptsize\bfseries\color{orange!80!black}] {4G / WiFi / LoRa / etc.} (cloud);
    % De Internet a Servidor
    \draw[extlink] (cloud) -- node[right, font=\scriptsize\bfseries\color{orange!80!black}]
    {Imágen}(server);
    % De Servidor a Usuario Final
    \draw[extlink] (server) -- node[right, font=\scriptsize\bfseries\color{orange!80!black}] {Alerta} (user);

    % Brackets para destacar los aportes y desarrollos principales del proyecto
    \draw[teal!80!black, line width=1.1pt, rounded corners=2pt] (0.2, -0.6) -- (0.2, -0.8) -- (8.2, -0.8) -- (8.2, -0.6);
    \node[below=0.05cm, font=\scriptsize\bfseries\color{teal!80!black}] at (4.2, -0.8) {Red Malla y Sensado Local};

    \draw[teal!80!black, line width=1.1pt, rounded corners=2pt] (10.0, -0.6) -- (10.0, -0.8) -- (12.0, -0.8) -- (12.0, -0.6);
    \node[below=0.05cm, font=\scriptsize\bfseries\color{teal!80!black}] at (11.0, -0.8) {Servidor de\\Inferencia y Alertas};
